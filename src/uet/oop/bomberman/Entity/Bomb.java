...
//    Sức nổ của bomb ra các hướng
    ...
    private static boolean is_middle = false;   // Kiểm tra bomb có nổ ở trung tâm không?
    public static int is_bomb = 0;      // Kiểm tra xem ở đó có bomb không (0: không có, 1: có bom, 2 nổ)

    public Bomb(int x, int y, Image img) {
        super(x, y, img);
    }

    public static void putBomb() {      // đặt bomb
    ...
    public static void activeBomb() {   // animation của bomb
        if (swap_active == 1) {
    ...
    public static void createEdge() {   // Ngăn cản chuyển động của nhân vật cũng như phạm vi nổ của bom
