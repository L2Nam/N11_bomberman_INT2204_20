...
//    public static Sprite grass = new Sprite(16, 7, 0, SpriteSheet.tiles, 16, 16);
//    public static Sprite brick = new Sprite(16, 5, 0, SpriteSheet.tiles, 16, 16);
//    public static Sprite wall = new Sprite(16, 6, 0, SpriteSheet.tiles, 16, 16);
    ...
    |--------------------------------------------------------------------------
     */
    public static Sprite player_up = new Sprite(16, 0, 0, SpriteSheet.tiles, 16, 16);
    ...
    public static Sprite player_up2 = new Sprite(16, 0, 0 + 12, SpriteSheet.tiles, 12, 16);
    public static Sprite player_down2 = new Sprite(16, 2, 0 + 12, SpriteSheet.tiles, 12, 15);
    public static Sprite player_left2 = new Sprite(16, 3, 0 + 12, SpriteSheet.tiles, 10, 15);
    public static Sprite player_right2 = new Sprite(16, 1, 0 + 12, SpriteSheet.tiles, 10, 16);

    public static Sprite player_up_12 = new Sprite(16, 0, 1 + 12, SpriteSheet.tiles, 12, 16);
    public static Sprite player_up_22 = new Sprite(16, 0, 2 + 12, SpriteSheet.tiles, 12, 15);

    public static Sprite player_down_12 = new Sprite(16, 2, 1 + 12, SpriteSheet.tiles, 12, 15);
    public static Sprite player_down_22 = new Sprite(16, 2, 2 + 12, SpriteSheet.tiles, 12, 16);

    public static Sprite player_left_12 = new Sprite(16, 3, 1 + 12, SpriteSheet.tiles, 11, 16);
    public static Sprite player_left_22 = new Sprite(16, 3, 2 + 12, SpriteSheet.tiles, 12, 16);

    public static Sprite player_right_12 = new Sprite(16, 1, 1 + 12, SpriteSheet.tiles, 11, 16);
    public static Sprite player_right_22 = new Sprite(16, 1, 2 + 12, SpriteSheet.tiles, 12, 16);

    public static Sprite player_dead12 = new Sprite(16, 4, 2 + 12, SpriteSheet.tiles, 14, 16);
    public static Sprite player_dead22 = new Sprite(16, 5, 2 + 12, SpriteSheet.tiles, 13, 15);
    public static Sprite player_dead32 = new Sprite(16, 6, 2 + 12, SpriteSheet.tiles, 16, 16);
