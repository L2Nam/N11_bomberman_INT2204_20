...
public class Sprite {
    ...
    // Load ảnh lên màn với pixels * SIZE
    private void load() {
    ...
    // Khởi tạo màu ban đầu cho các đối tượng
    public static Sprite transparent = new Sprite(ORIGINAL_SIZE, 15, 15, 16, 16, SpriteSheet.tiles);

    // Khởi tạo các đối tượng cho grass, brick, Portal, wall
    ...
    /* Khởi tọa hình ảnh khi bomber : up, down, right, and left */
    ...
    /* Character/Enemy: Tạo một đối tượng cho mỗi kẻ thù và theo dõi hướng di chuyển */
    ...
    /* FlameSegment Sprites: Tạo ngọn lửa bom đối tượng, phạm vi mặc định là 2px theo chiều dọc và chiều ngang, bắt đầu ở vị trí trung tâm */
    ...
    /* Powerups: Phân đoạn ngọn lửa khi máy bay ném bom nhận được các vật phẩm sức mạnh */
    ...
    // Chức năng này được sử dụng để thiết lập trò chơi trong màu trong suốt bằng màu Argb đã đặt.
